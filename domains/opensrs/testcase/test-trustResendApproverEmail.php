...
<form action="test-trustResendApproverEmail.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="trustResendApproverEmail">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td><input value="Resend Approver Email" type="submit"></td>
		</tr>
	</table>
</form>
