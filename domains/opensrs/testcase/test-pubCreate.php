...
if (isSet($_POST['function'])) {
	...
	$callArray = array (
		...
		"data" => array (
			...
			"end_user_auth_info" => $_POST["end_user_auth_info"],
...
<form action="test-pubCreate.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="pubCreate">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">end_user_auth_info </span> <input type="text" name="end_user_auth_info" value="" class="frontBox"></td>
		</tr>
		<tr>
