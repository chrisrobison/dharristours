...
<form action="test-pubGenerateRedirectionCode.php" method="post">
	<input type="hidden" name="format" value="<?php echo($tf); ?>">
	<input type="hidden" name="function" value="pubGenerateRedirectionCode">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td width="100%"><span class="headLine">programming language </span> <input type="text" name="programming_language" value="javascript" class="frontBox"></td>
		</tr>
		<tr>
			<td><input value="Generate" type="submit"></td>
		</tr>
	</table>
</form>
