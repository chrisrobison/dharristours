...
if (isSet($_POST['function'])) {
	...
	$callArray = array (
		...
		"data" => array (
			...
			"seal_in_search" => $_POST["seal_in_search"],
	...
	<body>
		<form action="test-trustUpdateProduct.php" method="post">
			<input type="hidden" name="format" value="<?php echo($tf); ?>">
			<input type="hidden" name="function" value="trustUpdateProduct">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				<tr>
					<td width="100%"><span class="headLine">seal_in_search</span> <input type="text" name="seal_in_search" value="" class="frontBox"></td>
				</tr>
								<tr>
