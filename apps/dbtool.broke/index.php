   ...
   <body>
      ...
      <form name='dbtool' id='dbtool' action='index.php' method='post'>
         <div id='toolbar'>
            ...
            <div id='tblbtn'><button class='newtbl' id='newtbl'>New Table</button><button class='newtbl' id='newimporttbl'>New Table from Import</button><button class='newtbl' id='tblimport'>Import into Existing Table</button><span id='dbTitle' style='float:left;'><?php print preg_replace("/^SS_/", '', $db); ?> Database</span></div>
            <div id='showtables'>
            </div>
      ...
      <script type='text/javascript'>
         ...
         $(document).ready(function() {
            ...
            $("div.tableDiv").mouseup(function() {
               debugger;
               // $("div.tableDiv").css("z-index", "1");
               // $(this).css("z-index", mui.zmax);
            });
            ...
            $(".showcheck").bind('click', function(evt) {
               ...
               if (tbl) {
                  ...
                  if (ui.state[tbl].showing) {
                     ...
                     tableStore = pos.left + ':' + pos.top + ':' + $("#"+tbl+"_container").css('display') + ':' + $("#table_"+tbl).css("z-index") + ':1';
                  } else {
                     ui.state[tbl].showing = 1;
                     ui.state[tbl].hidden = 0;
                     $("#show_"+tbl).attr("checked","checked");
                     $("#table_"+tbl).css('display', 'block');
                     tableStore =  pos.left + ':' + pos.top + ':' + $("#"+tbl+"_container").css('display') + ':' + $("#table_"+tbl).css("z-index") + ':0';
                  }
