...
*/
   ...
   $types['advanced'] = array('tinyint'=>'1', 'smallint'=>'1', 'mediumint'=>1, 'integer'=>1, 'bigint'=>1, 'real'=>1, 'double'=>1, 'float'=>1, 'decimal'=>1, 'numeric'=>1, 'date'=>0, 'time'=>0, 'timestamp'=>0, 'datetime'=>0, 'char'=>1, 'varchar'=>1, 'tinyblob'=>0, 'blob'=>0, 'mediumblob'=>0, 'longblob'=>0, 'tinytext'=>1, 'text'=>1, 'mediumtext'=>1, 'longtext'=>1, 'enum'=>1, 'set'=>1);
   $types['simple'] = array('Short Text'=>'varchar(50)', 'Medium Text'=>'varchar(150)', 'Long Text'=>'text', 'Number'=>'int(15)', 'Decimal'=>'dec(15,4)', 'Currency'=>'dec(8,2)', 'Checkbox'=>'bool', 'Date'=>'date', 'Time'=>'time', 'Date & Time'=>'datetime', 'Timestamp'=>'timestamp', 'File'=>'blob');
