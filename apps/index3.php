   ...
   <head>
    ...
    <body class="claro">
        <div dojoType="dijit.layout.BorderContainer" style="width:100%;height:100%;border:0px;">
            <div dojoType="dijit.layout.ContentPane" region="left" style="padding:0;position:relative;width:190px;overflow:hidden;">
               <div region="top" style="height:125px;" id='appLogo'><img src="<?php print $boss->app->Assets . "/" . $boss->app->Logo; ?>" border="0" /></div>
               <div id="accordion" class='nav' dojoType="dijit.layout.AccordionContainer" style="width:190px;top:130px;padding:0px;margin:0px;left:0px;position:absolute;bottom:0px;">
                  <?php include("nav3_cp.php"); ?>
               </div>
            </div>
            <div dojoType="dijit.layout.TabContainer" tabstrip="true" id="tabs" region="center">
            ...
            <div dojoType="dijit.layout.ContentPane" region="bottom" id="footer" style="height:32px;">
               <div id="copy">
                  <a target="_blank" href="http://www.simplesoftwaresf.com/">Simple Software Co. of SF</a><br/>
                  &copy; Copyright 2010, All Rights Reserved
               </div>
               <div id="status">Status: <span id='status'>OK</span><br />Logged in as: <?php print $_SESSION['Email']; ?> [<a href="/login.php?logout=true" target="_top" style="color:#0000ff;text-decoration:underline;">Logout</a>]</div>
            </div>
         </div>
    </body>
</html>
