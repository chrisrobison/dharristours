...
<div id='viewChartWrap' style='top:22%;'><span id='viewChartIcon'>Ý</span><a href='/apps/report/report.php?ReportID=<?php print $current->ReportID; ?>' class='viewChart' target='_blank'>View report in new window</a></div>
<div id='reportWrap' style='position:absolute;top:27%;bottom:4px;left:0px;right:4px;border:1px inset #a0a0a0;'>
<iframe id='reportFrame' name='reportFrame' width='100%' height='100%' src='/apps/report/report.php?ReportID=<?php print $current->ReportID; ?>'> </iframe>
</div>
