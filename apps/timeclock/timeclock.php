<?php
   ...
   if (($in['x'] == 'update') && ($_SESSION['UserID'])) {
      ...
      $cond = "Date='".date("Y-m-d", time())."' AND Punch='{$in['p']}' AND EmployeeID='{$_SESSION['Employee']->EmployeeID}'";
      $tc->getlist($cond);
      // print "<h1>$cond</h1>\n";
      ...
      <div id='clockDiv'>
         ...
         <div id='clockWrap'>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width='186' height='140' id="clockObject">
               <param name="movie"   value="/lib/swf/relog.swf"/>
               <param name="quality" value="high"/>
               <param name="bgcolor" value="#ffffff"/>
               <param name="wmode"   value="transparent"/>
               <param name="menu"    value="false"/>
               <embed src="/lib/swf/relog.swf" quality="high" bgcolor="#ffffff"  width="186" height="140" wmode="transparent" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" menu="false" id='clockBody2'> </embed>
            </object>
         </div>
      </div>
      <div id='timesheet'>
