...
<html>
   ...
   <body onload="init();">
      <div id='content'>
         <form action='outliner.php' name='outlineform' id='outlineform' method='post'>
            ...
            <div id='controls' onmouseover="ui.over='button'">
              <!-- <a href='#save' onclick='saveOutline();' onmousedown="press('save')" onmouseup="release('save')"><img id='save' src='img/toolbar/btn_save.png' class='btn' title='Save Outline' /></a> -->
            </div>
      ...
      <div id='docwrap'><iframe name='editDoc' id='editDoc' height='100%' width='100%' scrolling='no' src='editor.php'></iframe></div>
