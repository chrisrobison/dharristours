...
Docs & License: nhttps://fullcalendar.io/
(c) 2019 Adam Shaw
*/
...
(function (global, factory) {
    ...
    */
    ...
    var RELEASE_DATE = '2020-02-03'; // for Scheduler
    ...
    function injectLicenseWarning(containerEl, calendar) {
        ...
        if (!isImmuneUrl(window.location.href) && !isValidKey(key)) {
            core.appendToElement(containerEl, '<div class="fc-license-message" style="' + core.htmlEscape(core.cssToStr(CSS)) + '">' + '</div>');
        }
    }
    /*
