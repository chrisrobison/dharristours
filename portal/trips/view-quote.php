                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                        <svg class="svg-inline--fa fa-minus" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="minus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z"></path></svg><!-- <i class="fas fa-minus"></i> Font Awesome fontawesome.com -->
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-6">
                                                <input type="date" id="Date" name="Date" value="<?php print $current->Date; ?>" class="form-control form-control-border"><span class="easepick-wrapper" style="position: absolute; pointer-events: none;"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-3">
                                                <input type="number" id="Passengers" placeholder="# of passengers" name="Pax" value="<?php print $current->Pax; ?>" class="form-control form-control-border" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin-bottom:0.5rem;">
                                    ...
                                    <input type="text" name="Pickup" id="Pickup" class="form-control form-control-border" value="<?php print $current->Pickup; ?>" >
                                </div>
                                <!--===================================================-->
    ...
    foreach ($dests as $idx=>$dest) {
        ...
        print <<<EOT
                               <div class="form-group">
                                    ...
                                    <input type="text" name="Waypoint$num" id="Waypoint$num" class="form-control form-control-border" value="$dest" >
                               </div>
EOT;
    }
}
?>
                               ...
                               <div class="form-group">
                                    ...
                                    <input type="text" name="FinalDropOff" id="FinalDropOff" class="form-control form-control-border" value="<?php print $current->Return; ?>" >
                               </div>
                               <div class="row">
                                   <div class="col-sm-3">
                                       <div class="form-group">
                                           <label for="jobLocation">Pick-up Time</label>
                                           <input type="time" id="Start" name="Request[Start]" class="form-control form-control-border" style="width:8.5rem;" value="<?php print $current->Start; ?>" >
                                       </div>
                                   </div>
                                   <div class="col-sm-3">
                                       <div class="form-group">
                                           <label for="jobLocation">Return Time</label>
                                           <input type="time" id="End" name="Request[End]" class="form-control form-control-border" style="width:8.5rem;" value="<?php print $current->End; ?>" >
                                       </div>
                                   </div>
                                   <div class="col-sm-6">
                                       <fieldset style="display:flex;flex-direction:row;align-items:center;justify-content:space-around;width:100%;">
                                           ...
                                           <div class="checks">
                                               <input type="checkbox" id="input_ADA" class="form-control" value="1" <?php print (isset($current->ADA)) ? " CHECKED" : ""; ?> >
                                               <label for="input_ADA">ADA</label>
                                           </div>
                                           <div class="checks">
                                               <input type="checkbox" id="input_SPAB" class="form-control" value="1" <?php print (isset($current->SPAB)) ? " CHECKED" : ""; ?> >
                                               <label for="input_SPAB">SPAB</label>
                                           </div>
                                           <div class="checks">
                                               <input type="checkbox" id="input_Cargo" class="form-control" value="1" <?php print (isset($current->Cargo)) ? " CHECKED" : ""; ?> >
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-body p-0 map-card">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-flex">
                                        <img src="/portal/assets/finishflag.svg" height="32" width="32" style="float: left; height:32px; width:32px; margin: 0.25rem;">
                                        <label>Destination</label>
                                        <div class="showval" id="destination0"></div>
                                    </div>
                                     <div class="row">
                                        <div class="col-sm-6">
