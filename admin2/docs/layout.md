...
Simple 3.0 provides a set of options to apply to your main layout. Each one of these classes can be added to the body tag to get the desired goal.
...
Simple 3.0 provides a set of color variations to apply to your sidebar (light & dark) & navbar. You can combine any available color with these class prefixes:
...
> ###### New
> You can use override the link/accent color in Simple, you can add `.accent-*` to `body`.
{: .quote-info}
