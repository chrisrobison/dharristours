...
function loadUrl(who, title, tgt, force, mid, isModule) {
      ...
      var pane = new dijit.layout.ContentPane({
         ...
         onClose: function(pane, tab) {
            ...
            if (localStorage) {
               ...
               localStorage.setItem("tabs", JSON.stringify(simpleConfig.tabs));
   ...
   if (simpleConfig) {
      ...
      if (localStorage) localStorage.setItem("tabs", JSON.stringify(simpleConfig.tabs));
   }
   return false;
}
