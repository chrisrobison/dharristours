...
<html>
   <head>
      ...
      <style>
         ...
         ul ul { font-size: 1em; position:absolute;top:12em;}
         ul { position:relative; }
         ul li { text-align:center; height:8em;-moz-box-shadow:1em 1em 1em rgba(0,0,0,.4);-webkit-box-shadow:1em 1em 1em rgba(0,0,0,.4);box-shadow:1em 1em 1em rgba(0,0,0,.4);width:12em; }
         ...
         li { padding:.9em; list-style-type:none; font-weight:normal; margin:1em; }
         ...
         .plus { font-size:9em;font-weight:bold;color:#993333; position:relative;top:-.25em;
         -webkit-text-shadow:-2px -1px 0px rgba(0,0,0,1);
         -moz-text-shadow:-2px -1px 0px rgba(0,0,0,1);
         text-shadow:-2px -1px 0px rgba(0,0,0,1);
         }
         li:before {  } 
         li.closed, li.open { float:left;width:8em;}
         li + ul { display:none; }
         .data { color:#0022ff; }
         ...
         .plusWords { font-size:1.4em; position:relative; top:-2.5em; } 
         .punch:active { margin-top: 14px;
         ...
         .punch {
           ...
           border-color: rgb(83, 83, 83) rgb(45, 45, 45) rgb(30, 30, 30);
           ...
           */
           -moz-box-shadow: 0pt 2px 20px 2px rgb(139, 139, 139) inset, 0px 2px 0pt rgb(44, 44, 44), 0pt 12px 0px rgb(48, 48, 48), 0pt 16px 8px 2px rgb(17, 17, 17);
           -webkit-box-shadow: 0pt 2px 20px 2px rgb(139, 139, 139) inset, 0px 2px 0pt rgb(44, 44, 44), 0pt 12px 0px rgb(48, 48, 48), 0pt 16px 8px 2px rgb(17, 17, 17);
           box-shadow: 0pt 2px 20px 2px rgb(139, 139, 139) inset, 0px 2px 0pt rgb(44, 44, 44), 0pt 12px 0px rgb(48, 48, 48), 0pt 16px 8px 2px rgb(17, 17, 17);
      ...
      <!-- <div id='appLogo' style='float:left'><img src="<?php print "/img/logo.png"; ?>" height='75' /><br></div> -->
  </head>
   <body>
      
      <div id='dash'>
         <h1>D'Harris Tours</h1>
         <p>Click a button below to get started.</p>
         <!--<button id='expandAll'>Expand All</button><button id='collapseAll'>Collapse All</button> -->
         <ul>
            <li class='punch' rel="nav"><a class="nav" href="/grid/?pid=247" title="Schedule Trip" rel="nav"><span class='plus'>+</span><br><span class='plusWords'>Quotes</span></a></li>
            <ul>
               <li>
                  <a class="nav" href="/grid/?pid=247" title="Schedule Trip" rel="nav"></a>
                  
               </li>
               </ul>
            <li class='punch' rel="nav"><a class="nav" href="/grid/?pid=216" title="Jobs" rel="nav"><span class='plus'>+</span><br><span class='plusWords'>Jobs</span></a></li>
            <ul>
               <li>
                  <a class="nav" href="/grid/?pid=216" title="Jobs" rel="nav"></a>
                  
               </li>
            </ul>
          </ul>
                  <iframe name='calFrame' id='calFrame' src="/clients/dharristours/templates/cal2.php" width='800' height='600'></iframe>
      </div>
   </body>
   ...
   <script type='text/javascript'>
      ...
      $(document).ready(function() {
         ...
         $("li").click(function() { 
            if ($(this).next().is('ul')) { 
               $(".form").hide();
               $(this).toggleClass("closed").toggleClass("open").next('ul').toggle(250);
               if ($(this).attr('rel') == "cal") {
                  $("#calFrame").attr("src", "/clients/dharristours/templates/cal.php");
               }
            } 
         });
