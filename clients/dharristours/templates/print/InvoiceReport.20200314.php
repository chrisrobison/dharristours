...
<head>
<link type="text/css" href="http://fonts.googleapis.com/css?family=Quicksand:400,700" rel="stylesheet" />
...
<body>
   ...
   <div class="Part">
    ...
    <br />
      ...
      <div id='ticket' >
	    ...
	    <div class="date center"><?php print $business->AttnTo; ?></div>
       ...
       <table id='ticket_table'>
	       ...
	       <td class='value'><?php print $job->JobID; ?></td>
	       ...
	       <td class='value'><?php print $job->Job; ?></td>
               <td class='field'>Job Location: </td>
	    ...
	    <tr>
            ...
            <tr>
               ...
               <td class='value'><?php if ($current->InvoiceAmt==$job->QuoteAmount) {print 0;} print (float) $current->InvoiceAmt - (float) $job->QuoteAmount; ?></td>
               <td></td>
	    </tr>
            <tr>
               <td></td>
   ...
   <br /><br />
   <p><span class="bold">Cancellation Policy: </span> a charge of $400 if service not cancelled 72 hours prior to spot time. Full charge for on the spot cancellation. Thank you for your business!</p>
   <br />
   </div>
</body>
</html>
