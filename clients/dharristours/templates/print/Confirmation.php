...
<body>
   ...
   <div id='top_overview'>
      ...
      <span class='pass'><?php print $job->NumberOfItems; ?></span>
   </div>
    <div id='top_header'>
       <div>Num Pass: <b><?php print $job->NumberOfItems; ?></b></div>
       <div>Date: <?php print $job->JobDate; ?><br />Start: <?php print $job->PickupTime; ?></div>
   </div>
   <div class="Part">
      <table id="header">
         <tr>
