...
//   $in['Resource'] = "Job";
    $sql = 'JobID = '.$in['ID'].' and BusinessID in (select BusinessID from Business where LoginID='.$_SESSION['LoginID'].')';
//   print_r($in);
   $job = $boss->getObjectRelated('Job', $sql,false);
//print_r($sql);
//   $alljobs = $boss->getObject($in['Resource'], $in['ID']);
   $business = $boss->getObjectRelated('Business',$job->Job[0]->BusinessID);
   $driver = $boss->getObjectRelated('Employee',$job->Job[0]->EmployeeID);
...
<body>
   ...
   <div id='top_overview'>
      <span class='date'><?php print $job->Job[0]->JobDate; ?></span><br />
      <span class='time'><?php print $job->Job[0]->PickupTime; ?></span><br />
      <span class='desc'><?php print $business->Business; ?></span><br />
      <span class='pass'><?php print $job->Job[0]->NumberOfItems; ?></span>
   </div>
    <div id='top_header'>
       <div>Num Pass: <b><?php print $job->Job[0]->NumberOfItems; ?></b></div>
       <div>Date: <?php print $job->Job[0]->JobDate; ?><br />Start: <?php print $job->Job[0]->PickupTime; ?></div>
   </div>
   <div class="Part">
      <table id="header">
         <tr>
      ...
      <div id='ticket' >
         <div style="padding:4px;">
            ...
            <div class="date center"><?php print $job->Job[0]->JobDate; ?></div>
         </div>
         <div class='big'><?php print $job->Job[0]->Job; ?></div>
         <div class='big'><?php print $job->Job[0]->Description; ?></div>
         <br />
         <table id='ticket_table'>
            ...
            <tr>
               <td class='field'></td>
               <td class='value'><?php print $job->Job[0]->BusinessLocation; ?></td>
               <td class='field'></td>
               <td class='value'></td>
            </tr>
            ...
            <tr>
               ...
               <td class='value'><?php print $job->Job[0]->PickupTime; ?></td>
               <td class='field'>Drop Off Time:</td>
               <td class='value'><?php print $job->Job[0]->DropOffTime; ?></td>
            </tr>
            <tr>
               <td class='field'>P/U Location:</td>
               <td class='value'><?php print $job->Job[0]->PickupLocation; ?></td>
            </tr>
            <tr>
               <td class='field'>D/O Location:</td>
               <td class='value'><?php print $job->Job[0]->DropOffLocation; ?></td>
            </tr>
            <tr>
               <td class='field'>Final Drop:</td>
               <td class='value'><?php print $job->Job[0]->FinalDropOffLocation; ?></td>
               <td class='field'></td>
               <td class='value'></td>
            </tr>
            <tr><td colspan="3"><br /></td></tr>
            <tr>
               ...
               <td class='value' colspan='3'><?php print $job->Job[0]->Hours; ?><br /><br /></td>
            </tr>
            <tr>
               <td class='field'>Quote Amount:</td>
               <td class='value' colspan='3'><?php print $job->Job[0]->QuoteAmount; ?><br /><br /></td>
            </tr>
         </table>
      </div>
   <table id='sigs'>
