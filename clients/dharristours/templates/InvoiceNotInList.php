<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      ...
      <div class='fieldcolumn'>
         ...
         <div class='contentField'><label>Invoice Sent</label><select dbtype='tinyint(1)' name='Invoice[<?php print $current->InvoiceID; ?>][InvoiceSent]' id='InvoiceSent'><option value='0'>No</option><option value='1'>Yes</option></select></div>
         <div class='contentField'><label>Gas</label><input type='text' dbtype='decimal(10,0)' name='Invoice[<?php print $current->InvoiceID; ?>][Gas]' id='Gas' value='' size='50' class='boxValue' /></div>
         <div class='contentField'><label>Misc Cost</label><input type='text' dbtype='decimal(10,0)' name='Invoice[<?php print $current->InvoiceID; ?>][MiscCost]' id='MiscCost' value='' size='50' class='boxValue' /></div>
</div>
