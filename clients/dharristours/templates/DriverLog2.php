...
<head>
    ...
    <style type="text/css">
        ...
        body {
            ...
            font-size: 12pt;
            color: black;
            font-family: "Lexend", "Helvetica Neue", Verdana, sans-serif;
        }
...
<body>
    <div id="main" class='shadow'>
        <div id='top_overview'>
            <span class='date'>2021-08-26</span><br />
            <span class='time'>15:15:00</span><br />
            <span>SF Boys Girls Club</span><br />
            <span class='pass'>Pax: 44<br /></span>
            <span class='pass'>Bus: 40 (4001)</span>
        </div>
        <div id='top_header'>
            <div>Driver Name: <b>Doris</b><br />Job Number: <b> 23255</b></div>
            <div>Date: <b>2021-08-26</b><br />Start: <b>15:15:00</b></div>
        </div>
        <div class="Part">
            <table id="header">
                <tr>
         ...
         <tr>
            ...
            <div id='ticket'>
                <div style="padding:4px; position:relative;">
                    ...
                    <div class="date center">8/26/2021 at </div>
                    <div class="date center">3:15pm</div>
                </div>
                <table id='ticket_table'>
                    <tr>
                        <td class='field' style="width:10%;">Job:</td>
                        <td class='value' style="width:90%;">SF Boys Girls Club Bus 1</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class='value'>3:15pm</td>
                    </tr>
                    <tr>
                        <td class='field'>End Time:</td>
                        <td class='value'>4:30pm</td>
                    </tr>

                    <tr>
                        <td class='field'>1st Stop:</td>
                        <td class='value'>3531 22nd St. to 1) 450 Guerrero 2) 901 Alabama and 21st SF<br /></td>
                    </tr>
                    <tr>
                        <td colspan="3"><br /></td>
                    </tr>
                    <tr>
                        ...
                        <td class='value'>4:00 pm (1050 York St.)<br /></td>
                    </tr>
                    <tr>
                        <td colspan="3"><br /></td>
                    </tr>
                    <tr>
                        ...
                        <td class='value'>450 Guerrero St San Fco</td>
                    </tr>
                    <tr>
                        <td colspan="3"><br /></td>
                    </tr>
                    <tr>
                        ...
                        <td class='value' colspan='3'>.<br /><br /></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
            ...
            <table width="100%">
                <tr>
                    <th width=70%><b>SF Boys Girls Club</b>
                    </th>
                    <td>
            ...
            <table id="stats">
                <tr>
                    <td>Pre Trip Completed at <span class='line'></span>:<span class='line'></span></td>
                    <td>Mileage: <span class='line miles'></span></td>
                </tr>
                <tr>
