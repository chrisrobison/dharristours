<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      <div class='fieldcolumn fieldfloater'>
         <div class='contentField'><label>Resource</label><input type='text' dbtype='varchar(3)' name='JobCal[<?php print $current->JobCalID; ?>][Resource]' id='Resource' value='' size='3' class='boxValue' /></div>
