<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      <div class='fieldcolumn fieldfloater'>
         ...
         <div class='contentField'><label>y</label><input type='text' dbtype='int(10)' name='Damage[<?php print $current->DamageID; ?>][y]' id='y' value='<?php print $current->y; ?>' size='10' class='boxValue' /></div>
      </div>
      <div class='fieldcolumn'>
         <div class='contentField'><label>x</label><input type='text' dbtype='int(10)' name='Damage[<?php print $current->DamageID; ?>][x]' id='x' value='<?php print $current->x; ?>' size='10' class='boxValue' /></div>
<?php print $current->Notes; ?>
         <div class='contentField'><label>Severity</label><input type='text' dbtype='int(2)' name='Damage[<?php print $current->DamageID; ?>][Severity]' id='Severity' value='<?php print $current->Severity; ?>' size='2' class='boxValue' /></div>
</div>
