...
<?php print $current->Notes; ?>
         ...
         <div class='contentField'><label>Recipient</label><input type='text' dbtype='int(11)' name='MessageThreadNotification[<?php print $current->MessageThreadNotificationID; ?>][Recipient]' id='Recipient' value='<?php print $current->Recipient; ?>' size='11' class='boxValue' /></div>
      </div>
      <div class='fieldcolumn'>
         ...
         <div class='contentField' style='clear:left'><label>Notes</label><textarea dbtype='mediumtext' name='MessageThreadNotification[<?php print $current->MessageThreadNotificationID; ?>][Notes]' id='Notes' style='width:48em;' class='textBox'></textarea></div></div>
</div>