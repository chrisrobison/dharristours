<div class='tableGroup'>
   ...
   <button name='driverLogButton' style='float:middle' onclick='window.open("<?php print $boss->app->Assets; ?>/templates/DriverLog.php?ID="+simpleConfig.id, "btnJobWin", "height=800,width=600,resizable=yes,scrollbars=yes,status=yes,toolbar=yes,menubar=yes,location=no,personalbar=no");return false;'>Print Driver Log</button>
   <div class='fieldcontainer'>
      <div class='fieldcolumn fieldfloater'>
	 <div class='contentField'><span class='fieldLabel'>Completed: </span><select dbtype='tinyint(4)' name='Job[<?php print $current->JobID; ?>][JobCompleted]' id='JobCompleted'><option value='0'>No</option><option value='1'>Yes</option></select></div>
         <div class='contentField'><span class='fieldLabel'>Confirmed: </span><span name='Job[][Confirmed]' id='Confirmed'></span></div>
