...
<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      <input type='hidden' name='sendEmail' id='sendEmail' value='Change' default='Change' />
      <div class='fieldcolumn fieldfloater'>
         <div class='contentField'><label>Quote Amount: $</label><span name='Quote[][Quote]' id='Quote'></span></div>
 	 <div class='contentField'><label>Status: </label><span name='Quote[][Status]' id='Status'></span></div>
         ...
         <div class='contentField'><label>Date Requested: </label><input type='text' dbtype='date' name='Quote[<?php print $current->QuoteID; ?>][Date]' id='Date' value='' size='25' class='boxValue date' /></div>
...
<select id='Start_hour' onchange="updateTime('Start');">
               ...
               <select id='Start_meridian' onchange="updateTime('Start');">
...
<select id='End_hour' onchange="updateTime('End');">
      ...
      <div class='fieldcolumn fieldfloater'>
         ...
         <div class='contentField'><label>SPAB: </label><select dbtype='tinyint(1)' name='Quote[<?php print $current->QuoteID; ?>][SPAB]' id='SPAB'><option value='0'>No</option><option value='1'>Yes</option></select></div>
      </div>
      <div id='specspan' style="clear:left" class='contentField'><span class='fieldLabel'>Special Instructions - </span><textarea name='Quote[<?php print $current->QuoteID; ?>][SpecialInstructions]' id='SpecialInstructions' class='textBox' style='width:45em;height:5em;'><?php print $current->SpecialInstructions; ?></textarea></div>
   </div>
</div>
