...
<div class='tableGroup'>
   ...
   <button name='driverLogButton' style='float:left' onclick='window.open("<?php print $boss->app->Assets; ?>/templates/QuoteToJob.php?ID="+simpleConfig.id, "btnJobWin", "height=800,width=600,resizable=yes,scrollbars=yes,status=yes,toolbar=yes,menubar=yes,location=no,personalbar=no");return false;'>Create Job</button>
