<link rel='stylesheet' type='text/css' href='/lib/sdk/maps.css'/>
<script src='/files/templates/time_2.js?ver=1.32' type='text/javascript' async> </script>
...
<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
	...
	<fieldset class='jobstatus' title="Tracking">
		  ...
		  <label>RT Miles (miles * 1.1)</label><input type="hidden" disabled id='totalmiles' value="0"/><span id='grandtotalmeters' class="ui-widget-content"></span>
<span id='totalmeters' class="ui-widget-content"></span>
	       </div>
	       <div class='contentField'>
                  <label>* Date</label>
...
<fieldset class='jobstatus' title="Invoice Status">
	...
	<div class='contentField'>
	       ...
	       <div class='contentField'>
               <label>Total</label><span id='travelStartTimeCost'></span> 
	       </div>
	           </fieldset>
...
<script src='/lib/sdk/maps-web.min.js'> </script>
<script src='/files/templates/tomtom.js?ver=1.32' type='text/javascript' async> </script>
