	...
	<script type="text/javascript">
		...
		dojo.addOnLoad(function () {
			...
			var baseDate = dojoc.dojocal.dateOnly(new Date()),
				...
				firstUserCalendar = new dojoc.dojocal.UserCalendar({id: 'firstCal', color: 'red', fontColor: '#665500'}),
//				firstUserCalendar = new dojoc.dojocal.UserCalendar({id: 'firstCal', color: '#eeaaff', fontColor: '#444400'}),
				secondUserCalendar = new dojoc.dojocal.UserCalendar({id: '2ndCal', color: 'sandybrown', fontColor: '#005566'});
               ...
               <?php 
                  ...
                  foreach ($events as $event) {
                     if ($event->LoginID=='0') {
                        ...
                        $out .= "summary: '".$event->Employee." X".$event->NumberOfItems."',";
                        $out .= "description: '".$event->Job."',";
