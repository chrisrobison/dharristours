<script src='/files/templates/time.js?ver=1.31' type='text/javascript' async> </script>
   ...
   <div id="customButtons">
      <div id='mbtnWrap'><a id='MoreButton' rel='More' title='Tools to interact with your data' class='simpleButton buttonMenu'><span class='ui-icon ui-icon-plusthick'> </span>More...<span class='menuButton ui-icon ui-icon-triangle-1-s'> </span></a>
         <div id="MoreMenu" class='menu toolsMenu'>
            <ul>
               <li id='NotifyCustomer'  class='disabled' onclick='doNotify_old("business");'><span class='ui-icon ui-icon-calculator'></span> Call Now</li>
               ...
               <li id='createInvoiceButton' class='disabled' onclick='return openWin("<?php print $boss->app->Assets; ?>/templates/JobToPrint.php?ID="+simpleConfig.id+"#InvoiceReport", "btnInvWin")'><span class='ui-icon ui-icon-document'></span> Create Invoice</li>
               <li class='divider'><hr /></li>
