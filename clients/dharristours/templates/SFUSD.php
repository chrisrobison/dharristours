<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      ...
      <span class='fieldcolumn'>
         ...
         <div class='contentField'><span class='fieldLabel'>Last Updated</span><input type='text' name='Job[<?php print $current->JobID; ?>][LastUpdated]' id='LastUpdated' value='<?php print $current->LastUpdated; ?>' size='25' class='boxValue' /></div>
      </span>
   </div>
</div>