...
<body>
    <div id="main" class='shadow'>
      ...
      ?></span><br />
        ...
        <div id='top_header'>
            <div class='top_important'>Driver: <b>
                    <?php print $driver->Employee; ?></b>
            </div>
            <div class='top_important'>Bus: <b>
                    <?php print $bus->Bus; ?></b>
            </div>
            <div class='top_important'>PAX: <b>
                    <?php print $current->NumberOfItems; ?></b>
            </div>
            <div>Start:<b>
                    <?php  print date("g:ia", strtotime($current->PickupTime)); ?></b>
            </div>
        </div>
        <div class="Part">
            <table id="header">
	   ...
	   <td>juanaharrisdht@att.net</td><td>TCP 017270-B</td> <td>CA 273437</td>
         ...
         <tr>
            ...
            <table width="100%">
                <tr>
                    <th width=70%>PLEASE CONFIRM/EXCHANGE CONTACT INFO: <b></th>
                    <th> </th>
                </tr>    
                <tr>
                    <th>
                ...
                <tr>
                  <td>
                       Chaperone: <?php print $current->ContactName; ?> </td>
                  <td>
                     PH: <?php print $current->ContactPhone; ?>
                  </td>
                </tr>
            </table>
           <br />
        ...
        <div id='main' class='shadow'>
            <div id='top_header'>
                <div>Driver Name: <b>
                        <?php print $driver->Employee; ?></b>
                        <br />Job Number: <b>
                        <?php print $current->JobID; ?></b>
                </div>
                <div>Date: <b>
                        <?php print $current->JobDate; ?></b>
                        <br />Bus: <b>
                        <?php print $bus->Bus; ?></b>
                </div>
            </div>
