   ...
   <div id="customButtons">
      <div id='mbtnWrap'><a id='MoreButton' rel='More' title='Tools to interact with your data' class='simpleButton buttonMenu'><span class='ui-icon ui-icon-plusthick'> </span>More...<span class='menuButton ui-icon ui-icon-triangle-1-s'> </span></a>
         <div id="MoreMenu" class='menu toolsMenu'>
            <ul>
               <li id='myReportButton' onclick='return openWin("/apps/report.php?ReportID=9")'><span class='ui-icon ui-icon-clipboard'></span> Report</li>
               ...
               <li > Old </li>
               <li id='InvoiceOldButton' class='disabled' onclick='return openWin("<?php print $boss->app->Assets; ?>/templates/forms/JobToInvoice.php?ID="+simpleConfig.id, "btnInvOld")'><span class='ui-icon ui-icon-clipboard'></span> Create Invoice </li>
               <li id='driverLogOldButton' class='disabled' onclick='return openWin("<?php print $boss->app->Assets; ?>/templates/DriverLog.php?ID="+simpleConfig.id, "btnDrvOldLog")'><span class='ui-icon ui-icon-clipboard'></span> Driver Log</li>
               <li id='confirmOldButton' class='disabled' onclick='return openWin("<?php print $boss->app->Assets; ?>/templates/Confirmation.php?ID="+simpleConfig.id , "btnConfOldWin")'><span class='ui-icon ui-icon-print'></span> 
Confirmation</li>
               <li id='subLogOld' class='disabled' onclick='openWin("<?php print $boss->app->Assets; ?>/templates/DriverLogExternal.php?ID="+simpleConfig.id, "btnLogOldWin")'><span class='ui-icon ui-icon-document-b'></span> Old Sub Log</li>
               <li class='divider'><hr /></li>
               <li > New </li>
               <li id='InvoiceButton' class='disabled' onclick='return openWin("<?php print $boss->app->Assets; ?>/templates/JobToPrint.php?ID="+simpleConfig.id + "#InvoiceReport", "btnInvWin")'><span class='ui-icon ui-icon-document'></span> Email Invoice</li>
               <li id='driverLogButton' class='disabled' onclick='return openWin("<?php print $boss->app->Assets; ?>/templates/JobToPrint.php?ID="+simpleConfig.id + "#DriverLog", "btnDrvLog")'><span class='ui-icon ui-icon-clipboard'></span> Emai Driver Log</li>
               <li id='confirmButton' class='disabled' onclick='return openWin("<?php print $boss->app->Assets; ?>/templates/JobToPrint.php?ID="+simpleConfig.id + "#Confirmation", "btnConfWin")'><span class='ui-icon ui-icon-print'></span> Email Confirmation</li>
