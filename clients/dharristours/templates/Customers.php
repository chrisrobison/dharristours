<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      ...
      <div class='fieldcolumn'>
         ...
         <div class='contentField'><label>Cash Only</label><select dbtype='tinyint(4)' name='Business[<?php print $current->BusinessID; ?>][CashOnly]' id='CashOnly'><option value='0'>No</option><option value='1'>Yes</option></select></div>
         ...
         <div class='contentField'><label>Credit Lock</label><select dbtype='tinyint(4)' name='Business[<?php print $current->BusinessID; ?>][CreditLock]' id='CreditLock'><option value='0'>No</option><option value='1'>Yes</option></select></div>
         ...
         <div class='contentField'><label>Active</label><select dbtype='tinyint(4)' name='Business[<?php print $current->BusinessID; ?>][Active]' id='Active'><option value='0'>No</option><option value='1'>Yes</option></select></div>
         <div class='contentField'><label>Login </label><?php $boss->db->addResource("Login");$arr = $boss->db->Login->getlist();print $boss->utility->buildSelect($arr, $current->LoginID, "LoginID", "Login", "Business[$current->BusinessID][LoginID]")."</div>";?>
</div>
</div>
</div>