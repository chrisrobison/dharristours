...
<div class='contentField'><label>Dept Num</label><input type='text' dbtype='varchar(100)' name='Employee[<?php print $current->EmployeeID; ?>][DeptNum]' id='DeptNum' value='' size='50' class='boxValue' /></div>
