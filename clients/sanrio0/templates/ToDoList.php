<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      <div class='fieldcolumn fieldfloater'>
         ...
         <div class='contentField'><label>AssignedTo</label><?php $boss->db->addResource("Employee");$arr = $boss->db->Employee->getlist();print $boss->utility->buildSelect($arr, $current->EmployeeID, "EmployeeID", "Employee", "ToDo[$current->ToDoID][AssignedTo_EmployeeID]")."</div>";?>
