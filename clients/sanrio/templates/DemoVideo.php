<div class='tableGroup'>
   <div class='formHeading'>Action ID: <?php print $current->ActionID; ?></div>
   <div class='fieldcontainer'>
      <div class='fieldcolumn fieldfloater'>
         <div class='contentField'><label>Process </label><?php $boss->db->addResource("Process");$arr = $boss->db->Process->getlist();print $boss->utility->buildSelect($arr, $current->ProcessID, "ProcessID", "Process", "Action[$current->ActionID][ProcessID]")."</div>";?>
