<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      <div class='fieldcolumn fieldfloater'>
         ...
         <div class='contentField'><label>Host</label><input type='text' dbtype='varchar(100)' name='Report[<?php print $current->ReportID; ?>][Host]' id='Host' value='<?php print $current->Host; ?>' size='50' class='boxValue' /></div>
         <div class='contentField'><label>DB</label><input type='text' dbtype='varchar(100)' name='Report[<?php print $current->ReportID; ?>][DB]' id='DB' value='<?php print $current->DB; ?>' size='50' class='boxValue' /></div>
      </div>
      <div class='fieldcolumn'>
         <div class='contentField'><label>DBType</label><input type='text' dbtype='varchar(100)' name='Report[<?php print $current->ReportID; ?>][DBType]' id='DBType' value='<?php print $current->DBType; ?>' size='50' class='boxValue' /></div>
         ...
         <div class='contentField'><label>Description</label><input type='text' dbtype='varchar(200)' name='Report[<?php print $current->ReportID; ?>][Description]' id='Description' value='<?php print $current->Description; ?>' size='50' class='boxValue' /></div>
