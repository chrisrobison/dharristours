...
<?php print $current->Notes; ?>
      ...
      <div class='fieldcolumn'>
         ...
         <div class='contentField'><label>Last Deployed</label><input type='text' dbtype='datetime' name='App[<?php print $current->AppID; ?>][LastDeployed]' id='LastDeployed' value='<?php print $current->LastDeployed; ?>' size='25' class='boxValue date' /></div>
         <div class='contentField'><label>Deployed</label><select dbtype='tinyint(1)' name='App[<?php print $current->AppID; ?>][Deployed]' id='Deployed'><option value='0'>No</option><option value='1'>Yes</option><?php print $current->Deployed; ?></select></div>
