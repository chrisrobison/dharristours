<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      ...
      <div class='fieldcolumn'>
         <h3>Database</h3>
         <p style='display:none;'>
            <div class='contentField'><label>Name</label><input type='text' dbtype='varchar(100)' name='App[<?php print $current->AppID; ?>][DB]' id='DB' value='<?php print $current->DB; ?>' size='50' class='boxValue' /></div>
            <div class='contentField'><label>Host</label><input type='text' dbtype='varchar(50)' name='App[<?php print $current->AppID; ?>][DBHost]' id='DBHost' value='<?php print $current->DBHost; ?>' size='50' class='boxValue' /></div>
            <div class='contentField'><label>User</label><input type='text' dbtype='varchar(50)' name='App[<?php print $current->AppID; ?>][DBUser]' id='DBUser' value='<?php print $current->DBUser; ?>' size='50' class='boxValue' /></div>
            <div class='contentField'><label>Password</label><input type='password' dbtype='varchar(50)' name='App[<?php print $current->AppID; ?>][DBPwd]' id='DBPwd' value='<?php print $current->DBPwd; ?>' size='50' class='boxValue' /></div>
         </p>
