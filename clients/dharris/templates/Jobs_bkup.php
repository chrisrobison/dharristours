...
function doPrint() {
   window.open("/clients/dharris/templates/DriverLog.php?ID=<?php print $current->JobID; ?>", "JobWin", "height=800,width=600,resizable=yes,scrollbars=yes,status=no,toolbar=no,menubar=no,location=no,personalbar=no");
   window.open("/clients/dharris/templates/DriverLog.php?ID=<?php print $current->JobID; ?>", "JobWin2", "height=800,width=600,resizable=yes,scrollbars=yes,status=no,toolbar=no,menubar=no,location=no,personalbar=no");
}
</script>
