...
<div class='tableGroup'>
   ...
   <div class='fieldcontainer'>
      <span class='fieldcolumn fieldfloater'>
         <div class='contentField'><span class='fieldLabel'>Request Title</span><input type='text' name='ScheduleRequest[<?php print $current->ScheduleRequestID; ?>][ScheduleRequest]' id='ScheduleRequest' value='<?php print $current->ScheduleRequest; ?>' size='50' class='boxValue' /></div>
      <!--
