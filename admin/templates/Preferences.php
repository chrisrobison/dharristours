...
<div id='prefcontent' style='position:absolute;top:25px;left:0px;right:0px;bottom:0px;overflow:auto;overflow:-moz-scrollbars-vertical;'>
...
<div class='floatBorder'>&nbsp;</div>
<script language='Javascript' type='text/javascript'>
   <?php
      print $jsout;
      print $jsuser; 
   ?>
   setTimeout( function() { buildPrefTree('tree', sitetree, user) }, 750);
</script>
<input type='hidden' name='Login[<?php print $current->LoginID; ?>][ModulePref]' id='ModulePref' value='<?php print $current->ModulePref; ?>' />
<input type='hidden' name='Login[<?php print $current->LoginID; ?>][ProcessPref]' id='ProcessPref' value='<?php print $current->ProcessPref; ?>' />
<div class='tableGroup' style='height:100%;'>
   ...
   <div class='fieldcontainer'>
      <span class='fieldcolumn'>
         ...
         <div class='contentField'><span class='fieldLabel'>Timeclock Style</span>
             <select name='Login[<?php print $current->LoginID; ?>][TimeclockStyle]' id='TimeclockStyle'>
               <option value='relog.swf'<?php print ($current->TimeclockStyle=='relog.swf') ? ' SELECTED' : ''; ?>>Default Timeclock</option>
               <option value='anaclock.swf'<?php print ($current->TimeclockStyle=='anaclock.swf') ? ' SELECTED' : ''; ?>>Metered Style</option>
            </select>
         </div>
      </span>
   </div>
